...
export const initialAppData: AppData = {
  ...
  aqi: { value: 35, status: '良好', pm25: 12, pm10: 25, o3: 30, no2: 10 },
  srdi: 'safe',
...
export const initialHourlyForecast: HourlyForecast[] = [
  { time: '現在', temp: '22°', icon: 'sun', iconColor: '#FACC15', pop: '0%' },
  { time: '13:00', temp: '23°', icon: 'sun', iconColor: '#FACC15', pop: '0%' },
  { time: '14:00', temp: '24°', icon: 'cloud', iconColor: '#CBD5E1', pop: '10%' },
  { time: '15:00', temp: '23°', icon: 'cloud', iconColor: '#CBD5E1', pop: '20%' },
  { time: '16:00', temp: '21°', icon: 'droplets', iconColor: '#60A5FA', pop: '50%' },
  { time: '17:00', temp: '20°', icon: 'droplets', iconColor: '#60A5FA', pop: '60%' },
];

export const initialWeeklyForecast: WeeklyForecast[] = [
  { day: '今天', icon: 'sun', iconColor: '#FACC15', pop: '0%', nightIcon: 'moon', nightIconColor: '#818CF8', nightPop: '0%', min: '18', max: '26', progressWidth: '60%', progressLeft: '20%' },
  { day: '週一', icon: 'cloud', iconColor: '#CBD5E1', pop: '10%', nightIcon: 'cloud', nightIconColor: '#CBD5E1', nightPop: '10%', min: '19', max: '24', progressWidth: '50%', progressLeft: '30%' },
  { day: '週二', icon: 'droplets', iconColor: '#60A5FA', pop: '40%', nightIcon: 'droplets', nightIconColor: '#60A5FA', nightPop: '50%', min: '17', max: '21', progressWidth: '40%', progressLeft: '10%' },
  { day: '週三', icon: 'droplets', iconColor: '#60A5FA', pop: '70%', nightIcon: 'droplets', nightIconColor: '#60A5FA', nightPop: '60%', min: '16', max: '19', progressWidth: '30%', progressLeft: '5%' },
  { day: '週四', icon: 'cloud', iconColor: '#CBD5E1', pop: '20%', nightIcon: 'cloud', nightIconColor: '#CBD5E1', nightPop: '20%', min: '17', max: '23', progressWidth: '45%', progressLeft: '15%' },
  { day: '週五', icon: 'sun', iconColor: '#FACC15', pop: '0%', nightIcon: 'moon', nightIconColor: '#818CF8', nightPop: '0%', min: '19', max: '27', progressWidth: '65%', progressLeft: '25%' },
  { day: '週六', icon: 'sun', iconColor: '#FACC15', pop: '0%', nightIcon: 'moon', nightIconColor: '#818CF8', nightPop: '0%', min: '20', max: '28', progressWidth: '70%', progressLeft: '30%' },
];
