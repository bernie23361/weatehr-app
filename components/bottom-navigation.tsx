...
export function BottomNavigation({ activeTab, onChange, dark = false }: { activeTab: AppTab; onChange: (tab: AppTab) => void; dark?: boolean }) {
  ...
  return (
    <View style={{ position: 'absolute', left: 0, right: 0, bottom: 0, flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', paddingTop: 8, paddingBottom: Math.max(insets.bottom, 24), paddingHorizontal: 8, backgroundColor: dark ? '#111827' : '#FFFFFF', boxShadow: dark ? '0 -10px 20px rgba(0,0,0,0.4)' : '0 -10px 20px rgba(0,0,0,0.02)', zIndex: 20 }}>
